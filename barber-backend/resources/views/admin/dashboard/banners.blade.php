...
<div id="editBannerModal" class="modal" style="display: none; position: fixed; z-index: 1050; left: 0; top: 0; width: 100%; height: 100%; overflow-y: auto; background-color: rgba(0,0,0,0.8); backdrop-filter: blur(5px);">
    <div class="modal-content" style="background-color: var(--surface-card, #1e1e1e); margin: 5vh auto; padding: 30px; border: 1px solid var(--border-subtle, #333); border-radius: 15px; width: 92%; max-width: 550px; box-shadow: 0 25px 50px -12px rgba(0,0,0,0.5); position: relative;">
        <h3 style="color: var(--accent-gold); margin-bottom: 20px; font-size: 1.5rem; border-bottom: 1px solid var(--border-subtle, #333); padding-bottom: 10px;">Edit Banner</h3>
        <form id="editBannerForm" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label>Deskripsi</label>
                <textarea id="editBannerDescription" name="description" style="height: 100px; width: 100%; box-sizing: border-box; resize: vertical; padding: 10px; border-radius: 8px; border: 1px solid var(--border-subtle, #444); background: var(--surface-light, #2a2a2a); color: white;"></textarea>
            </div>
            <div class="form-group">
            ...
            <div style="margin-top: 1.5rem; display: flex; gap: 15px; justify-content: flex-end; border-top: 1px solid var(--border-subtle, #333); padding-top: 20px;">
                <button type="button" class="btn-secondary" onclick="closeEditBannerModal()" style="padding: 10px 20px; border-radius: 8px;">Batal</button>
